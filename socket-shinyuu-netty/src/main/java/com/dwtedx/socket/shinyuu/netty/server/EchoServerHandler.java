package com.dwtedx.socket.shinyuu.netty.server;

import com.dwtedx.socket.shinyuu.netty.encoder.Header;
import com.dwtedx.socket.shinyuu.netty.encoder.Message;
...
/**
 * Description
 * Created by shinyuu on 2022/4/15 2:05 PM.
 */
...
public class EchoServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        System.out.println("客户端" + ctx.name() + "已连接");
    }
